...
client = clickhouse_connect.get_client(host='localhost', port=8123, database='nord_jaren')
...
df_ko.to_csv("data/inndata_nord-jaren_ko.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
...
df_reiser.to_csv("data/inndata_nord-jaren_reiser.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
...
df_nokkel.to_csv("data/inndata_nord-jaren_nokkel.csv", sep=";", decimal=",", index=False, encoding="utf-8-sig")
